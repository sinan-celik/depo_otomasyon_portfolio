...
namespace SimulationMaker
{
    ...
    public class Server
    {
        ...
        private ConcurrentDictionary<TcpClient, NetworkStream> clientBuffers;
        ...
        {
            this.port = port;
            clientBuffers = new ConcurrentDictionary<TcpClient, NetworkStream>();
        ...
        private void ListenForClients()
        {
            ...
            while (started)
            {
                ...
                NetworkStream newBuff = new NetworkStream(socket);
                //newBuff.Write = new byte[sendBufferSize];
                //newBuff.Read = new byte[readBufferSize];
        ...
        private void WorkWithClient(object client)
        {
            ...
            while (started)
            {
                ...
                try
                {
                    ...
                    bytesRead = clientStream.Read(readBuffer, 0, readBufferSize);
                }
                catch
                {
                ...
                if (OnDataReceived != null)
                {
                    ...
                    OnDataReceived(readBuffer, bytesRead, tcpClient);
                }
